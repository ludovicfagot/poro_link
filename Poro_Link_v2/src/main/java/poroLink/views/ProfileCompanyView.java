...
public class ProfileCompanyView extends BaseView{
	...
	/**
	 * @param txtDescriptionPost the txtDescriptionPost to set
	 */
...
//	}
	...
	public ProfileCompanyView(JFrame frame) {
		...
		gbl_panelBlock.columnWidths = new int[]{177, 118, 103, 172, 0};
		gbl_panelBlock.rowHeights = new int[]{37, 36, 36, 0};
		gbl_panelBlock.columnWeights = new double[]{1.0, 0.0, 0.0, 1.0, Double.MIN_VALUE};
		gbl_panelBlock.rowWeights = new double[]{0.0, 0.0, 0.0, Double.MIN_VALUE};
		...
		txtRecruteurCoordonnee.setForeground(Color.BLACK);
		txtRecruteurCoordonnee.setBackground(Color.WHITE);
		scrollPane.setViewportView(txtRecruteurCoordonnee);
		...
		panel.add(lblListeDeComptence, gbc_lblListeDeComptence);
